...
def normalize_arabic_query(term: str) -> str:
    ...
    term = term.lower()
    brands = {
        'ال جي': 'lg', 'وايت ويل': 'white whale', 'يونيون اير': 'unionaire',
        'سامسونج': 'samsung', 'توشيبا': 'toshiba', 'شارب': 'sharp',
        'سوني': 'sony', 'زانوسي': 'zanussi', 'بيكو': 'beko',
        'شاومي': 'xiaomi', 'ميديا': 'midea', 'كارير': 'carrier',
        'تيفال': 'tefal', 'براون': 'braun', 'فيليبس': 'philips',
        'ديلونجي': 'delonghi', 'تورنيدو': 'tornado', 'اريستون': 'ariston'
    }
    ...
    irregular_plurals = {
        ...
        "أطقم": "طقم", "اطقم": "طقم", "كنبات": "كنب", "ركنات": "ركن",
        "سجاجيد": "سجاد", "ستاير": "ستار", "ستائر": "ستار",
        ...
        "غرفة": "غرف", "غرفه": "غرف",
        "تلاجات": "ثلاج", "تلاجة": "ثلاج", "تلاجه": "ثلاج", 
        "ثلاجات": "ثلاج", "ثلاجة": "ثلاج", "ثلاجه": "ثلاج"
    }
